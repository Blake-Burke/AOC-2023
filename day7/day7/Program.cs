        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < stringslist.Count; i++)
            {
                for (int j = 0; j < stringslist[i].Length; j++)
                {
                    ...
                    stringslist[i] = stringslist[i].Replace('J', '0');
                ...
                else
                {
                    ...
                    for(int cyclist = 0; cyclist < e.Length; cyclist++)
                    {
                        if (e[cyclist] == '0')
                        {
                            if(match >= match2 && match >= match3 && match >= match4)
                            {
                                match++;
                            }
                    ...
                    e = e;
                    // if all five
                    if (match == 5 || match2 == 5 || match3 == 5 || match4 == 5) { value = 7; }
                    // if four
                    else if (match == 4 || match2 == 4 || match3 == 4 || match4 == 4) { value = 6; }
                    // if 2+3
                    else if (match + match2 == 5 || match + match3 == 5 || match2 + match3 == 5 ) { value = 5; }
                    // if 3
                    else if (match == 3 || match2 == 3 || match3 == 3 || match4 == 3) { value = 4; }
                    // if 2+2
            ...
            {
                Console.WriteLine(values[i] + " " + cards[i] + " " + bids[i] + " " + (i + 1) + " " + (bids[i] * (i + 1)));
